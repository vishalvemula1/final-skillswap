...
const Select = React.forwardRef(({
  ...
  const baseStyles = 'w-full px-4 py-2 rounded-xl border-2 transition-smooth bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 cursor-pointer';
